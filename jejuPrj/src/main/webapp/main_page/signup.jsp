            ...
            <fieldset>
                ...
                <ul>
                    <li>
                        ...
                        <input type="text" id="su-id" autofocus placeholder="4자 ~ 10자 사이, 공백없이" required>
                    </li>
                    <li>
                        <label for="su_pwd"> 비밀번호 </label>
                        <input type="password" id="su-pwd" placeholder="문자와 숫자, 특수 기호 포함" required>
                    </li>
                    <li>
                        <label for="pwd_chk"> 비밀번호 확인 </label>
                        <input type="password" id="pwd_chk" placeholder="위 비밀번호와 동일한 비밀번호 입력" required>
                    </li>
                    <li>
                        <label for="su_mail"> 이메일 </label>
                        <input type="email" id="su_mail" required>
                    </li>
                </ul>
            </fieldset>
            <fieldset>
